...
public class Explosion implements Entity {
	...
	public static final int DEFAULT_EXPLOSION_EXTENSION = 1;
	public static final int UNIT = WallFactoryImpl.DEFAULT_WALL_WIDTH;
	public static final int THICKNESS = 35;
	...
	@Override
	public void tick() {
		if (System.nanoTime() - this.startTime > DEFAULT_TIMER_LENGTH) {
			this.end();
		}
	...
	public boolean shouldCollide(ICollidable collidable) {
		return (collidable instanceof Player || collidable instanceof Wall || collidable instanceof Bomb);
	}
